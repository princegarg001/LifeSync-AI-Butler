...
import 'dashboard_data.dart' as _i7;
import 'greetings/greeting.dart' as _i8;
import 'insight.dart' as _i9;
import 'task.dart' as _i10;
import 'user.dart' as _i11;
import 'package:my_project_server/src/generated/chat_message.dart' as _i12;
import 'package:my_project_server/src/generated/insight.dart' as _i13;
import 'package:my_project_server/src/generated/task.dart' as _i14;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  static final List<_i2.TableDefinition> targetTableDefinitions = [
    ...
    _i2.TableDefinition(
      ...
      indexes: [
        ...
        _i2.IndexDefinition(
          indexName: 'insight_dismissed_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
              definition: 'isDismissed',
            ),
          ],
          type: 'btree',
          isUnique: false,
  ...
  T deserialize<T>(
    ...
    if (t == _i7.DashboardData) {
      return _i7.DashboardData.fromJson(data) as T;
    }
    if (t == _i8.Greeting) {
      return _i8.Greeting.fromJson(data) as T;
    }
    if (t == _i9.Insight) {
      return _i9.Insight.fromJson(data) as T;
    }
    if (t == _i10.Task) {
    ...
    if (t == _i1.getType<_i7.DashboardData?>()) {
      return (data != null ? _i7.DashboardData.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i8.Greeting?>()) {
      return (data != null ? _i8.Greeting.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i9.Insight?>()) {
      return (data != null ? _i9.Insight.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i9.Insight>) {
      return (data as List).map((e) => deserialize<_i9.Insight>(e)).toList()
          as T;
    }
    if (t == List<_i10.Task>) {
    ...
    if (t == List<_i13.Insight>) {
      return (data as List).map((e) => deserialize<_i13.Insight>(e)).toList()
          as T;
    }
    if (t == List<_i14.Task>) {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i7.DashboardData => 'DashboardData',
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'DashboardData') {
      return deserialize<_i7.DashboardData>(data['data']);
    }
    if (dataClassName == 'Greeting') {
      return deserialize<_i8.Greeting>(data['data']);
    }
    if (dataClassName == 'Insight') {
      return deserialize<_i9.Insight>(data['data']);
    }
